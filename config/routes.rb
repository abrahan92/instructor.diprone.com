  ...
  resources :users do
    ...
    resources :cursos do
       ...
       resources :seccions do
        #match '/users/:id/cursos/:id/seccions/:id', controller: 'seccions', action: 'edit', via: 'get'
        #match '/seccions/41', controller: 'seccions', action: 'update', via: 'post'

        match '/seccions/:id', controller: 'seccions', action: 'delete', via: 'post'
       
        

        resources :clases do

          match '/users/:id/cursos/:id/seccions/:id/clases/:id', controller: 'clases', action: 'delete', via: 'post'
...
get '/users/:id/password', to: 'users#password', as: :users_password
get '/clases/:id/download', to: 'clases#download', as: :clases_download
get '/users/:id/red', to: 'users#red'
get '/users/:id/member', to: 'users#member'

get '/cerrarmes', to: 'users#cerrarmes'
get '/compresion', to: 'users#compresion'
