    ...
    [
      {
        href: '#',
        title: _('Dashboard'),
        content: "<i class='fa fa-lg fa-fw fa-home'></i> <span class='menu-item-parent'>" + _('Análitica') + "</span>",
        children: [
          {
            href: root_path,
            title: _('Dashboard'),
            content: "<span class='menu-item-parent'>" + _('Cursos') + "</span>"
          },
          {
            href: dashboard_social_path,
            title: _('Dashboard'),
            content: "<span class='menu-item-parent'>" + _('Instructores') + "</span>"
          },
        ]
      },
      # Menu Curso
      ...
      {
        href: '/users/'+current_user.id.to_s+'/cursos',
        title: _('Cursos'),
        content: "<i class='fa fa-lg fa-fw fa-graduation-cap'></i> <span class='menu-item-parent'>" + _('Cursos') + "</span> <span class='badge pull-right inbox-badge margin-right-13 numerocursos'></span>",
      },

      # Menu Curso
      {
        href: '#',
        content: "<i class='fa fa-lg fa-fw fa-cube txt-color-blue'></i> <span class='menu-item-parent'>" + _('Certificaciones') + "</span>",
        children: [
          {
      ...
      },
      {
        ...
        content: "<i class='fa fa-lg fa-fw fa-inbox'></i> <span class='menu-item-parent'>" + _('Correos') + "</span> <span class='badge pull-right inbox-badge margin-right-13'>14</span>",
      },
      {
        href: '#',
        content: "<i class='fa fa-lg fa-fw fa-bar-chart-o'></i> <span class='menu-item-parent'>" + _('Métricas') + "</span>",
        children: [
          {
      ...
      {
        href: '#',
        content: "<i class='fa fa-lg fa-fw fa-table'></i> <span class='menu-item-parent'>" + _('Calendario') + "</span>",
        children: [
          {
      ...
      {
        href: '#',
        content: "<i class='fa fa-lg fa-fw fa-pencil-square-o'></i> <span class='menu-item-parent'>" + _('Beneficios') + "</span>",
        children: [
          {
